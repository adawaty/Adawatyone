...
const dictionaries: Record<Lang, Dict> = {
  en: {
    ...
    "funnel.eyebrow": "Lead funnel",
    "funnel.title": "Get a DFY scope in 2 minutes",
    "funnel.subtitle": "Answer a few questions and we’ll route you to the right service — then reply with a clear sprint plan and deliverables.",
    "funnel.chip.1": "Reply in 24–48h",
    "funnel.chip.2": "Fixed scope sprints",
    "funnel.chip.3": "No handoffs",
    "funnel.proof.1.k": "Fast",
    "funnel.proof.1.v": "Short form → prefilled contact → next step.",
    "funnel.proof.2.k": "Clear scope",
    "funnel.proof.2.v": "We lock deliverables early to avoid surprises.",
    "funnel.proof.3.k": "Adoption",
    "funnel.proof.3.v": "We ship what teams actually use.",

    "funnel.form.title": "Tell us what you need",
    "funnel.form.subtitle": "We’ll prefill the contact page so you don’t repeat yourself.",
    "funnel.form.name": "Name",
    "funnel.form.namePh": "Your name",
    "funnel.form.email": "Email",
    "funnel.form.emailPh": "name@company.com",
    "funnel.form.company": "Company",
    "funnel.form.companyPh": "Company name (optional)",
    "funnel.form.phone": "Phone",
    "funnel.form.phonePh": "+20 … (optional)",
    "funnel.form.interested": "Interested in",
    "funnel.form.servicePh": "Select a service",
    "funnel.service.notSure": "Not sure yet",
    "funnel.form.goal": "Goal",
    "funnel.form.goalPh": "What outcome are you aiming for? (leads, bookings, credibility, workflows…)",
    "funnel.form.cta": "Continue",
    "funnel.form.disclaimer": "This is a static site funnel: it forwards you to the contact form with details prefilled.",

    "funnel.msgLine.company": "Company:",
    "funnel.msgLine.service": "Interested in:",

    "funnel.mail.subject": "New lead (Lead Funnel)",
    "funnel.mail.sent": "Admin email sent",
    "funnel.mail.failed": "Could not send admin email",
    "funnel.mail.notConfigured": "Admin email not configured yet",
  ...
  ar: {
    ...
    "funnel.eyebrow": "نموذج تواصل سريع",
    "funnel.title": "خد نطاق تنفيذ كامل في دقيقتين",
    "funnel.subtitle": "جاوب على شوية أسئلة بسيطة—ونحَوّلك لأقرب حل مناسب، وبعدها نرد عليك بخطة سبرنت وتسليمات واضحة.",
    "funnel.chip.1": "رد خلال 24–48 ساعة",
    "funnel.chip.2": "سبرنت بنطاق ثابت",
    "funnel.chip.3": "من غير لف ودوران",
    "funnel.proof.1.k": "سريع",
    "funnel.proof.1.v": "فورم مختصر → كونتاكت متعبّي تلقائي → خطوة جاية واضحة.",
    "funnel.proof.2.k": "نطاق واضح",
    "funnel.proof.2.v": "بنقفل التسليمات بدري عشان مفيش مفاجآت.",
    "funnel.proof.3.k": "استخدام فعلي",
    "funnel.proof.3.v": "بنسلّم سيستم الناس بتستخدمه فعلاً.",

    "funnel.form.title": "قولنا محتاج إيه",
    "funnel.form.subtitle": "هنفتحلك صفحة التواصل متعبّية عشان ما تكررش الكلام.",
    "funnel.form.name": "الاسم",
    "funnel.form.namePh": "اسمك",
    "funnel.form.email": "الإيميل",
    "funnel.form.emailPh": "name@company.com",
    "funnel.form.company": "الشركة",
    "funnel.form.companyPh": "اسم الشركة (اختياري)",
    "funnel.form.phone": "الموبايل",
    "funnel.form.phonePh": "+20 … (اختياري)",
    "funnel.form.interested": "مهتم بإيه؟",
    "funnel.form.servicePh": "اختار الخدمة",
    "funnel.service.notSure": "مش متأكد لسه",
    "funnel.form.goal": "الهدف",
    "funnel.form.goalPh": "عايز توصل لإيه؟ (ليدز، حجوزات، ثقة، مسارات تشغيل…)",
    "funnel.form.cta": "كمّل",
    "funnel.form.disclaimer": "الموقع ستاتيك: الفورم ده بيودّيك لصفحة التواصل متعبّية بالتفاصيل.",

    "funnel.msgLine.company": "الشركة:",
    "funnel.msgLine.service": "مهتم بـ:",

    "funnel.mail.subject": "ليد جديد (نموذج التواصل)",
    "funnel.mail.sent": "اتبعت ملخص للإدارة",
    "funnel.mail.failed": "مقدرتش أبعت ملخص للإدارة",
    "funnel.mail.notConfigured": "لسه إعداد الإيميل مش متفعل",
